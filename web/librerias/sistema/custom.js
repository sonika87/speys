...
$(document).ready(function(){
  $('div.focus-area').hover(function(){
    $('div.focus-description2').eq($(this).index()).addClass('active').siblings().removeClass('active');
    $(this).addClass('highlight').siblings().removeClass('highlight');
  });
});
$(document).ready(function(){
  $('div.focus-area').hover(function(){
    $('div.focus-description3').eq($(this).index()).addClass('active').siblings().removeClass('active');
    $(this).addClass('highlight').siblings().removeClass('highlight');
  });
});
