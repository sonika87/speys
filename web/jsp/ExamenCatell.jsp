...
<head>
    ...
    <% List<PeguntaExamenBean> preguntas = (List<PeguntaExamenBean>) request.getAttribute("preguntas"); %>
...
<div class="container-fluid" id="content">
	<div id="left">
		<form action="search-results.html" method="GET" class='search-form'>
            ...
            <li><a> Pregunta <%=pregunta.getNumero() %></a></li>
            <% } %>
	</div>
	<div id="main">
		<div class="container-fluid">		
									...
									<form action="#" class="form-horizontal">
										...
										<div class="span10">
												<div class="control-group">
													...
													<div class="controls">
                                                                                                            <input type="text" name="name" class='input-xlarge' value="Nombre del paciente">
													</div>
												</div>
												<div class="control-group">
												...
												<div class="control-group">
													...
													<div class="controls">
														<textarea name="textarea" id="textarea" rows="3" class="input-block-level">Observaciones de la cita </textarea>
													</div>
												</div>

												<div class="control-group">
														<label for="textarea" class="control-label right">Medicamentos suministrados:</label>
													<div class="controls">
														<textarea name="textarea" id="textarea" rows="3" class="input-block-level">Medicamentos suministrados</textarea>
													</div>
												</div>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<input type="checkbox" name="checkbox"> Pago realizado
														</label>
													</div>
												</div>
												...
												<a class="content-remove">
													<input type="submit" class='btn btn-primary' value="Finalizar cita"></a>
